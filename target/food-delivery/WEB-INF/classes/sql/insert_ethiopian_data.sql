...
-- Insert Ethiopian Restaurants (Prices in Ethiopian Birr)
INSERT INTO restaurants (owner_user_id, name, address, cuisine_type, rating, min_order_value, is_active) VALUES
(1, 'Addis Ababa Restaurant', '123 Main Street, Addis Ababa, Ethiopia', 'Ethiopian', 4.8, 825.00, TRUE),
(1, 'Habesha Kitchen', '456 Bole Road, Addis Ababa, Ethiopia', 'Ethiopian', 4.7, 660.00, TRUE),
(1, 'Lucy Ethiopian Restaurant', '789 Churchill Avenue, Addis Ababa, Ethiopia', 'Ethiopian', 4.9, 990.00, TRUE),
(1, 'Mesob Ethiopian Cuisine', '321 Kazanchis, Addis Ababa, Ethiopia', 'Ethiopian', 4.6, 770.00, TRUE),
(1, 'Queen of Sheba Restaurant', '654 Piassa Street, Addis Ababa, Ethiopia', 'Ethiopian', 4.5, 880.00, TRUE);

-- Get restaurant IDs (assuming they were just inserted)
SET @restaurant1 = (SELECT id FROM restaurants WHERE name = 'Addis Ababa Restaurant' LIMIT 1);
SET @restaurant2 = (SELECT id FROM restaurants WHERE name = 'Habesha Kitchen' LIMIT 1);
SET @restaurant3 = (SELECT id FROM restaurants WHERE name = 'Lucy Ethiopian Restaurant' LIMIT 1);
SET @restaurant4 = (SELECT id FROM restaurants WHERE name = 'Mesob Ethiopian Cuisine' LIMIT 1);
SET @restaurant5 = (SELECT id FROM restaurants WHERE name = 'Queen of Sheba Restaurant' LIMIT 1);

-- Insert Ethiopian Menu Items for Addis Ababa Restaurant (Prices in Ethiopian Birr)
...
-- Insert Ethiopian Menu Items for Habesha Kitchen (Prices in Ethiopian Birr)
INSERT INTO menu_items (restaurant_id, name, description, price, category, is_available) VALUES
...
-- Insert Ethiopian Menu Items for Lucy Ethiopian Restaurant (Prices in Ethiopian Birr)
INSERT INTO menu_items (restaurant_id, name, description, price, category, is_available) VALUES
...
-- Insert Ethiopian Menu Items for Mesob Ethiopian Cuisine (Prices in Ethiopian Birr)
INSERT INTO menu_items (restaurant_id, name, description, price, category, is_available) VALUES
...
-- Insert Ethiopian Menu Items for Queen of Sheba Restaurant (Prices in Ethiopian Birr)
INSERT INTO menu_items (restaurant_id, name, description, price, category, is_available) VALUES
